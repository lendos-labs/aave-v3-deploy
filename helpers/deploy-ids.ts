...
export const ATOKEN_IMPL_ID = `osToken-${MARKET_NAME}`;
export const DELEGATION_AWARE_ATOKEN_IMPL_ID = `DelegationAwareOsToken-${MARKET_NAME}`;
...
export const ORACLE_ID = `LendOsOracle-${MARKET_NAME}`;
...
export const AAVE_COLLECTOR_PROXY_ID = `LendOsCollector-${PROXY_ID}-${MARKET_NAME}`;
export const AAVE_COLLECTOR_IMPL_ID = `LendOsCollector-${IMPL_ID}-${MARKET_NAME}`;
...
export const ATOKEN_PREFIX = `-osToken-${MARKET_NAME}`;
...
export const STAKE_AAVE_PROXY = `StakeLendOS-${PROXY_ID}`;
export const STAKE_AAVE_IMPL_V1 = `StakeLendOS-REV-1-${IMPL_ID}`;
export const STAKE_AAVE_IMPL_V2 = `StakeLendOS-REV-2-${IMPL_ID}`;
export const STAKE_AAVE_IMPL_V3 = `StakeLendOS-REV-3-${IMPL_ID}`;
